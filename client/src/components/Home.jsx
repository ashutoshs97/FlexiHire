        ...
        <div className='Home'>
                            ...
                            <div data-aos="fade-right">
                                <form onSubmit={e => handleSubmit(e)}>
                                    <div className="form-section" >
                                        ...
                                        <input type="text" ref={fullName} placeholder='Full Name' name="name" id="name" />
                                    </div>
                                    <div className="form-section">
                                        <label htmlFor="email">Email</label>
                                        <input type="text" ref={email} placeholder='fullname@gmail.com' name="email" id="email" />
                                    </div>
                                    <div className="form-section">
            ...
            <footer>
                ...
                <p className="footer-body">
                    FlexiHire  is a leading provider of freelance services, connecting talented individuals with clients who need their skills and expertise. From website design and development to writing and marketing, our team has the knowledge and experience to help you succeed.
                </p>
                <div className="footer-footer">
                    <div className="copyright">
                        Copyright FlexiHire  ©2025 | All Rights Reserved
                    </div>
