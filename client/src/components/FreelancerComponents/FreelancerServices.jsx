...
export default function FreelancerServices() {
  ...
  const profileImageUrl = avatar === 'no-image.png' 
    ? noImage 
    : `${process.env.REACT_APP_BACKEND_URL}/ProfilePic/${avatar}`; // Ensure the URL is from env variable
              ...
              {data?.allServices && data.allServices.length !== 0 ? data.allServices.map(service => (
                <div key={service._id} className="service-card">
                  ...
                  <div className="serviceHeader">
                    <img src={profileImageUrl} alt="Service" />
